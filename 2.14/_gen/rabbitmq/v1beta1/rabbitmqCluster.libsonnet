{
  ...
  '#':: d.pkg(name='rabbitmqCluster', url='', help='"RabbitmqCluster is the Schema for the RabbitmqCluster API. Each instance of this object\\ncorresponds to a single RabbitMQ cluster."'),
  ...
  spec: {
    ...
    override: {
      ...
      service: {
        ...
        spec: {
          ...
          withTrafficDistribution(trafficDistribution): { spec+: { override+: { service+: { spec+: { trafficDistribution: trafficDistribution } } } } },
          ...
          template: {
            ...
            spec: {
              ...
              resources: {
                ...
                '#withClaims':: d.fn(help='', args=[d.arg(name='claims', type=d.T.array)]),
                withClaims(claims): { spec+: { override+: { statefulSet+: { spec+: { template+: { spec+: { resources+: { claims: if std.isArray(v=claims) then claims else [claims] } } } } } } } },
                '#withClaimsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='claims', type=d.T.array)]),
                withClaimsMixin(claims): { spec+: { override+: { statefulSet+: { spec+: { template+: { spec+: { resources+: { claims+: if std.isArray(v=claims) then claims else [claims] } } } } } } } },
                '#withLimits':: d.fn(help='', args=[d.arg(name='limits', type=d.T.object)]),
                withLimits(limits): { spec+: { override+: { statefulSet+: { spec+: { template+: { spec+: { resources+: { limits: limits } } } } } } } },
                '#withLimitsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='limits', type=d.T.object)]),
                withLimitsMixin(limits): { spec+: { override+: { statefulSet+: { spec+: { template+: { spec+: { resources+: { limits+: limits } } } } } } } },
                '#withRequests':: d.fn(help='', args=[d.arg(name='requests', type=d.T.object)]),
                withRequests(requests): { spec+: { override+: { statefulSet+: { spec+: { template+: { spec+: { resources+: { requests: requests } } } } } } } },
                '#withRequestsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='requests', type=d.T.object)]),
                withRequestsMixin(requests): { spec+: { override+: { statefulSet+: { spec+: { template+: { spec+: { resources+: { requests+: requests } } } } } } } },
              },
              ...
              securityContext: {
                ...
                appArmorProfile: {
                  '#withLocalhostProfile':: d.fn(help='', args=[d.arg(name='localhostProfile', type=d.T.string)]),
                  withLocalhostProfile(localhostProfile): { spec+: { override+: { statefulSet+: { spec+: { template+: { spec+: { securityContext+: { appArmorProfile+: { localhostProfile: localhostProfile } } } } } } } } },
                  '#withType':: d.fn(help='', args=[d.arg(name='type', type=d.T.string)]),
                  withType(type): { spec+: { override+: { statefulSet+: { spec+: { template+: { spec+: { securityContext+: { appArmorProfile+: { type: type } } } } } } } } },
                },
                '#seLinuxOptions':: d.obj(help=''),
                seLinuxOptions: {
                  '#withLevel':: d.fn(help='', args=[d.arg(name='level', type=d.T.string)]),
                ...
                withSeLinuxChangePolicy(seLinuxChangePolicy): { spec+: { override+: { statefulSet+: { spec+: { template+: { spec+: { securityContext+: { seLinuxChangePolicy: seLinuxChangePolicy } } } } } } } },
                ...
                withSupplementalGroupsPolicy(supplementalGroupsPolicy): { spec+: { override+: { statefulSet+: { spec+: { template+: { spec+: { securityContext+: { supplementalGroupsPolicy: supplementalGroupsPolicy } } } } } } } },
    ...
    persistence: {
      '#withStorage':: d.fn(help='"The requested size of the persistent volume attached to each Pod in the RabbitmqCluster.\\nThe format of this field matches that defined by kubernetes/apimachinery.\\nSee https://pkg.go.dev/k8s.io/apimachinery/pkg/api/resource#Quantity for more info on the format of this field."', args=[d.arg(name='storage', type=d.T.any)]),
    ...
    rabbitmq: {
      '#withAdditionalConfig':: d.fn(help='"Modify to add to the rabbitmq.conf file in addition to default configurations set by the operator.\\nModifying this property on an existing RabbitmqCluster will trigger a StatefulSet rolling restart and will cause rabbitmq downtime.\\nFor more information on this config, see https://www.rabbitmq.com/configure.html#config-file"', args=[d.arg(name='additionalConfig', type=d.T.string)]),
      ...
      '#withAdvancedConfig':: d.fn(help='"Specify any rabbitmq advanced.config configurations to apply to the cluster.\\nFor more information on advanced config, see https://www.rabbitmq.com/configure.html#advanced-config-file"', args=[d.arg(name='advancedConfig', type=d.T.string)]),
      withAdvancedConfig(advancedConfig): { spec+: { rabbitmq+: { advancedConfig: advancedConfig } } },
      '#withEnvConfig':: d.fn(help='"Modify to add to the rabbitmq-env.conf file. Modifying this property on an existing RabbitmqCluster will trigger a StatefulSet rolling restart and will cause rabbitmq downtime.\\nFor more information on env config, see https://www.rabbitmq.com/man/rabbitmq-env.conf.5.html"', args=[d.arg(name='envConfig', type=d.T.string)]),
      withEnvConfig(envConfig): { spec+: { rabbitmq+: { envConfig: envConfig } } },
      '#withErlangInetConfig':: d.fn(help='"Erlang Inet configuration to apply to the Erlang VM running rabbit.\\nSee also: https://www.erlang.org/doc/apps/erts/inet_cfg.html"', args=[d.arg(name='erlangInetConfig', type=d.T.string)]),
    ...
    secretBackend: {
      ...
      vault: {
        ...
        tls: {
          ...
          '#withPkiIssuerPath':: d.fn(help='"Path in Vault PKI engine.\\nFor example \\"pki/issue/hashicorp-com\\".\\nrequired"', args=[d.arg(name='pkiIssuerPath', type=d.T.string)]),
          withPkiIssuerPath(pkiIssuerPath): { spec+: { secretBackend+: { vault+: { tls+: { pkiIssuerPath: pkiIssuerPath } } } } },
          '#withPkiRootPath':: d.fn(help='"Specifies an optional path to retrieve the root CA from vault.  Useful if certificates are issued by an intermediate CA"', args=[d.arg(name='pkiRootPath', type=d.T.string)]),
          withPkiRootPath(pkiRootPath): { spec+: { secretBackend+: { vault+: { tls+: { pkiRootPath: pkiRootPath } } } } },
        },
        '#withAnnotations':: d.fn(help='"Vault annotations that override the Vault annotations set by the cluster-operator.\\nFor a list of valid Vault annotations, see https://www.vaultproject.io/docs/platform/k8s/injector/annotations"', args=[d.arg(name='annotations', type=d.T.object)]),
        withAnnotations(annotations): { spec+: { secretBackend+: { vault+: { annotations: annotations } } } },
        '#withAnnotationsMixin':: d.fn(help='"Vault annotations that override the Vault annotations set by the cluster-operator.\\nFor a list of valid Vault annotations, see https://www.vaultproject.io/docs/platform/k8s/injector/annotations"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='annotations', type=d.T.object)]),
        withAnnotationsMixin(annotations): { spec+: { secretBackend+: { vault+: { annotations+: annotations } } } },
        '#withDefaultUserPath':: d.fn(help='"Path in Vault to access a KV (Key-Value) secret with the fields username and password for the default user.\\nFor example \\"secret/data/rabbitmq/config\\"."', args=[d.arg(name='defaultUserPath', type=d.T.string)]),
        withDefaultUserPath(defaultUserPath): { spec+: { secretBackend+: { vault+: { defaultUserPath: defaultUserPath } } } },
        '#withDefaultUserUpdaterImage':: d.fn(help="\"Sidecar container that updates the default user's password in RabbitMQ when it changes in Vault.\\nAdditionally, it updates /var/lib/rabbitmq/.rabbitmqadmin.conf (used by rabbitmqadmin CLI).\\nSet to empty string to disable the sidecar container.\"", args=[d.arg(name='defaultUserUpdaterImage', type=d.T.string)]),
    ...
    service: {
      ...
      '#withIpFamilyPolicy':: d.fn(help='"IPFamilyPolicy represents the dual-stack-ness requested or required by a Service\\nSee also: https://pkg.go.dev/k8s.io/api/core/v1#IPFamilyPolicy"', args=[d.arg(name='ipFamilyPolicy', type=d.T.string)]),
      ...
      '#withType':: d.fn(help='"Type of Service to create for the cluster. Must be one of: ClusterIP, LoadBalancer, NodePort.\\nFor more info see https://pkg.go.dev/k8s.io/api/core/v1#ServiceType"', args=[d.arg(name='type', type=d.T.string)]),
      withType(type): { spec+: { service+: { type: type } } },
    },
    '#tls':: d.obj(help='"TLS-related configuration for the RabbitMQ cluster."'),
    tls: {
      '#withCaSecretName':: d.fn(help="\"Name of a Secret in the same Namespace as the RabbitmqCluster, containing the Certificate Authority's public certificate for TLS.\\nThe Secret must store this as ca.crt.\\nThis Secret can be created by running `kubectl create secret generic ca-secret --from-file=ca.crt=path/to/ca.crt`\\nUsed for mTLS, and TLS for rabbitmq_web_stomp and rabbitmq_web_mqtt.\"", args=[d.arg(name='caSecretName', type=d.T.string)]),
      withCaSecretName(caSecretName): { spec+: { tls+: { caSecretName: caSecretName } } },
      '#withDisableNonTLSListeners':: d.fn(help='"When set to true, the RabbitmqCluster disables non-TLS listeners for RabbitMQ, management plugin and for any enabled plugins in the following list: stomp, mqtt, web_stomp, web_mqtt.\\nOnly TLS-enabled clients will be able to connect."', args=[d.arg(name='disableNonTLSListeners', type=d.T.boolean)]),
      withDisableNonTLSListeners(disableNonTLSListeners): { spec+: { tls+: { disableNonTLSListeners: disableNonTLSListeners } } },
      '#withSecretName':: d.fn(help="\"Name of a Secret in the same Namespace as the RabbitmqCluster, containing the server's private key \u0026 public certificate for TLS.\\nThe Secret must store these as tls.key and tls.crt, respectively.\\nThis Secret can be created by running `kubectl create secret tls tls-secret --cert=path/to/tls.crt --key=path/to/tls.key`\"", args=[d.arg(name='secretName', type=d.T.string)]),
    ...
    '#withReplicas':: d.fn(help='"Replicas is the number of nodes in the RabbitMQ cluster. Each node is deployed as a Replica in a StatefulSet. Only 1, 3, 5 replicas clusters are tested.\\nThis value should be an odd number to ensure the resultant cluster can establish exactly one quorum of nodes\\nin the event of a fragmenting network partition."', args=[d.arg(name='replicas', type=d.T.integer)]),
    withReplicas(replicas): { spec+: { replicas: replicas } },
    '#withSkipPostDeploySteps':: d.fn(help='"If unset, or set to false, the cluster will run `rabbitmq-queues rebalance all` whenever the cluster is updated.\\nSet to true to prevent the operator rebalancing queue leaders after a cluster update.\\nHas no effect if the cluster only consists of one node.\\nFor more information, see https://www.rabbitmq.com/rabbitmq-queues.8.html#rebalance"', args=[d.arg(name='skipPostDeploySteps', type=d.T.boolean)]),
    withSkipPostDeploySteps(skipPostDeploySteps): { spec+: { skipPostDeploySteps: skipPostDeploySteps } },
    '#withTerminationGracePeriodSeconds':: d.fn(help='"TerminationGracePeriodSeconds is the timeout that each rabbitmqcluster pod will have to terminate gracefully.\\nIt defaults to 604800 seconds ( a week long) to ensure that the container preStop lifecycle hook can finish running.\\nFor more information, see: https://github.com/rabbitmq/cluster-operator/blob/main/docs/design/20200520-graceful-pod-termination.md"', args=[d.arg(name='terminationGracePeriodSeconds', type=d.T.integer)]),
